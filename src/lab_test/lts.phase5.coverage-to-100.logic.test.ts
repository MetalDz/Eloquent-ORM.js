...
describe("LTS phase 5 coverage to 100", () => {
  ...
  test("phase plan records the refreshed baseline and ordered hotspot inventory", () => {
    ...
    const requiredSnippets = [
      ...
      "LTS-Phase5-SeedBootstrapPrecheck-Coverage-Plan.md",
      "src/cli/utils/resolveConnectionFlags.ts",
      "LTS-Phase5-ResolveConnectionFlags-Coverage-Plan.md",
      ...
      "LTS-Phase5-MigrateFresh-Coverage-Plan.md",
      ...
      "LTS-Phase5-MakeModel-Coverage-Plan.md",
      ...
      "src/index.ts",
      "LTS-Phase5-Index-Entrypoint-Coverage-Plan.md",
      "src/core/model/BaseModel.ts",
      "LTS-Phase5-BaseModel-Coverage-Plan.md",
      "src/core/model/BaseModelSafeFinderStatics.ts",
      "LTS-Phase5-BaseModelSafeFinderStatics-Coverage-Plan.md",
      "src/core/model/CoreModel.ts",
      "LTS-Phase5-CoreModel-Coverage-Plan.md",
