...
- local relative import/require matches in `src` and `bin`: `1320`
- unique TypeScript files affected: `349`
- import/export local specifiers: `1193`
